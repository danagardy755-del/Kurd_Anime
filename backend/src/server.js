...
import {sourceConfig,resolveEpisode} from './streaming.js';
...
export async function handler(req,res){
  ...
  try{
    ...
    if(p[1]==='anime'&&p[2]&&p[3]==='episode'&&p[4]&&req.method==='GET')return send(res,200,{data:{animeId:p[2],episode:p[4],sources:resolveEpisode(p[2],p[4])}});
